...
{
  /// <summary>
  /// A static class to hold a list of events for demonstration purposes.
  /// </summary>
  public class EventList
  {
    public static readonly IList<Event> events = new List<Event>
    {
        new Event
        ...
        new Event
        {
          Id = Guid.Parse("3a17b294-8716-448c-94db-ebf9bf53f1cf"),
          Year = 2024,
